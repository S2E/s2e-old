...
DEF_HELPER_FLAGS_1_M(cc_compute_all, TCG_CALL_PURE, i32, int, _M_CC, 0)
DEF_HELPER_FLAGS_1_M(cc_compute_c, TCG_CALL_PURE, i32, int, _M_CC, 0)

DEF_HELPER_0_M(lock, void, 0, 0)
DEF_HELPER_0_M(unlock, void, 0, 0)
DEF_HELPER_2_M(write_eflags, void, tl, i32, 0, _M_CC_SRC)
DEF_HELPER_0_M(read_eflags, tl, _M_CC, 0)
DEF_HELPER_1_M(divb_AL, void, tl, _M_EAX | _RM_EXCP, _M_EAX | _WM_EXCP)
DEF_HELPER_1_M(idivb_AL, void, tl, _M_EAX | _RM_EXCP, _M_EAX | _WM_EXCP)
DEF_HELPER_1_M(divw_AX, void, tl, _M_EAX | _M_EDX | _RM_EXCP,
                                  _M_EAX | _M_EDX | _WM_EXCP)
...
DEF_HELPER_1_M(aam, void, int, _M_EAX, _M_EAX | _M_CC_DST)
DEF_HELPER_1_M(aad, void, int, _M_EAX, _M_EAX | _M_CC_DST)
DEF_HELPER_0_M(aaa, void, _M_EAX | _M_CC, _M_EAX | _M_CC_SRC)
DEF_HELPER_0_M(aas, void, _M_EAX | _M_CC, _M_EAX | _M_CC_SRC)
DEF_HELPER_0_M(daa, void, _M_EAX | _M_CC, _M_EAX | _M_CC_SRC)
DEF_HELPER_0_M(das, void, _M_EAX | _M_CC, _M_EAX | _M_CC_SRC)

DEF_HELPER_1_M(lsl, tl, tl, _M_CC, _M_CC_SRC)
DEF_HELPER_1_M(lar, tl, tl, _M_CC, _M_CC_SRC)
DEF_HELPER_1_M(verr, void, tl, _M_CC, _M_CC_SRC)
DEF_HELPER_1_M(verw, void, tl, _M_CC, _M_CC_SRC)
DEF_HELPER_1_M(lldt, void, int, _RM_EXCP, _WM_EXCP)
DEF_HELPER_1_M(ltr, void, int, _RM_EXCP, _WM_EXCP)
DEF_HELPER_2_M(load_seg, void, int, int, _RM_EXCP, _WM_EXCP)
DEF_HELPER_3(ljmp_protected, void, int, tl, int)
DEF_HELPER_4_M(lcall_real, void, int, tl, int, int, _M_ESP, _M_ESP)
DEF_HELPER_4(lcall_protected, void, int, tl, int, int)
DEF_HELPER_1_M(iret_real, void, int, _M_ESP, _M_ESP | _M_CC_SRC)
DEF_HELPER_2(iret_protected, void, int, int)
DEF_HELPER_2(lret_protected, void, int, int)
DEF_HELPER_1_M(read_crN, tl, int, _RM_EXCP, _WM_EXCP)
DEF_HELPER_2_M(write_crN, void, int, tl, _RM_EXCP, _WM_EXCP)
DEF_HELPER_1_M(lmsw, void, tl, _RM_EXCP, _WM_EXCP)
DEF_HELPER_0_M(clts, void, 0, 0)
DEF_HELPER_2_M(movl_drN_T0, void, int, tl, 0, 0)
DEF_HELPER_1_M(invlpg, void, tl, _RM_EXCP, _WM_EXCP)

DEF_HELPER_3_M(enter_level, void, int, int, tl, _M_EBP | _M_ESP, 0)
#ifdef TARGET_X86_64
DEF_HELPER_3(enter64_level, void, int, int, tl)
#endif
DEF_HELPER_0_M(sysenter, void, _RM_EXCP, _M_ESP | _WM_EXCP)
DEF_HELPER_1_M(sysexit, void, int, _M_ECX | _M_EDX | _RM_EXCP, _M_ESP | _WM_EXCP)
#ifdef TARGET_X86_64
DEF_HELPER_1(syscall, void, int)
DEF_HELPER_1(sysret, void, int)
#endif
DEF_HELPER_1_M(hlt, void, int, _RM_EXCP, _WM_EXCP)
DEF_HELPER_1_M(monitor, void, tl, _M_ECX | _RM_EXCP, _WM_EXCP)
DEF_HELPER_1_M(mwait, void, int, _M_ECX | _RM_EXCP, _WM_EXCP)
DEF_HELPER_0_M(debug, void, 0, 0)
DEF_HELPER_0_M(reset_rf, void, 0, 0)
DEF_HELPER_2_M(raise_interrupt, void, int, int, _RM_EXCP, _WM_EXCP)
DEF_HELPER_1_M(raise_exception, void, int, _RM_EXCP, _WM_EXCP)
DEF_HELPER_0_M(cli, void, 0, 0)
DEF_HELPER_0_M(sti, void, 0, 0)
DEF_HELPER_0_M(set_inhibit_irq, void, 0, 0)
DEF_HELPER_0_M(reset_inhibit_irq, void, 0, 0)
DEF_HELPER_2_M(boundw, void, tl, int, _RM_EXCP, _WM_EXCP)
DEF_HELPER_2_M(boundl, void, tl, int, _RM_EXCP, _WM_EXCP)
DEF_HELPER_0(rsm, void)
DEF_HELPER_1_M(into, void, int, _RM_EXCP | _M_CC, _WM_EXCP)
DEF_HELPER_1_M(cmpxchg8b, void, tl,
               _M_CC | _M_EAX | _M_EBX | _M_ECX | _M_EDX,
               _M_EAX | _M_EDX | _M_CC_SRC)
#ifdef TARGET_X86_64
DEF_HELPER_1(cmpxchg16b, void, tl)
#endif
DEF_HELPER_0_M(single_step, void, _RM_EXCP, _WM_EXCP)
DEF_HELPER_0_M(cpuid, void, _RM_EXCP | _M_EAX | _M_ECX,
                            _WM_EXCP | _M_EAX | _M_ECX | _M_EBX | _M_EDX)
DEF_HELPER_0_M(rdtsc, void, _RM_EXCP, _WM_EXCP | _M_EAX | _M_EDX)
DEF_HELPER_0_M(rdtscp, void, _RM_EXCP, _WM_EXCP | _M_EAX | _M_EDX | _M_ECX)
DEF_HELPER_0_M(rdpmc, void, _RM_EXCP, _WM_EXCP)
DEF_HELPER_0(rdmsr, void)
DEF_HELPER_0(wrmsr, void)

DEF_HELPER_1_M(check_iob, void, i32, _RM_EXCP, _WM_EXCP)
DEF_HELPER_1_M(check_iow, void, i32, _RM_EXCP, _WM_EXCP)
DEF_HELPER_1_M(check_iol, void, i32, _RM_EXCP, _WM_EXCP)
DEF_HELPER_2_M(outb, void, i32, i32, 0, 0)
DEF_HELPER_1_M(inb, tl, i32, 0, 0)
DEF_HELPER_2_M(outw, void, i32, i32, 0, 0)
DEF_HELPER_1_M(inw, tl, i32, 0, 0)
DEF_HELPER_2_M(outl, void, i32, i32, 0, 0)
DEF_HELPER_1_M(inl, tl, i32, 0, 0)
...
DEF_HELPER_1_M(bsf, tl, tl, 0, 0)
DEF_HELPER_1_M(bsr, tl, tl, 0, 0)
DEF_HELPER_2_M(lzcnt, tl, tl, int, 0, 0)

/* MMX/SSE */

DEF_HELPER_0_M(enter_mmx, void, 0, 0)
DEF_HELPER_0_M(emms, void, 0, 0)
DEF_HELPER_2_M(movq, void, ptr, ptr, 0, 0)
...
DEF_HELPER_2_M(rclb, tl, tl, tl, _M_CC, _M_CC_TMP)
DEF_HELPER_2_M(rclw, tl, tl, tl, _M_CC, _M_CC_TMP)
DEF_HELPER_2_M(rcll, tl, tl, tl, _M_CC, _M_CC_TMP)
DEF_HELPER_2_M(rcrb, tl, tl, tl, _M_CC, _M_CC_TMP)
DEF_HELPER_2_M(rcrw, tl, tl, tl, _M_CC, _M_CC_TMP)
DEF_HELPER_2_M(rcrl, tl, tl, tl, _M_CC, _M_CC_TMP)
#ifdef TARGET_X86_64
DEF_HELPER_2_M(rclq, tl, tl, tl, _M_CC, _M_CC_TMP)
DEF_HELPER_2_M(rcrq, tl, tl, tl, _M_CC, _M_CC_TMP)
#endif
