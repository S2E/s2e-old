...
/* log support */
#ifdef _WIN32
static const char *logfilename = "d:/qemu.log";
#else
...
int walk_memory_regions(void *priv,
    int (*fn)(void *, uintptr_t, uintptr_t, uintptr_t))
{
    uintptr_t start, end;
    PageDesc *p = NULL;
    int i, j, prot, prot1;
...
static int dump_region(void *priv, uintptr_t start,
    uintptr_t end, uintptr_t prot)
{
    FILE *f = (FILE *)priv;
